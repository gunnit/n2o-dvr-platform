# N2O DVR Design System (Stripe-inspired)

## 0. N2O Brand Overrides (READ FIRST)

This project uses Stripe's structural design language -- typography, spacing, shadows, radius scale, data-density principles -- but keeps N2O's navy brand identity. When this section conflicts with sections below, **this section wins**.

| Concern | Stripe default | **N2O override** |
|---|---|---|
| Primary / CTA color | `#533afd` (purple) | `#003d74` (N2O navy) |
| Primary hover | `#4434d4` | `#1b5594` |
| Heading color | `#061b31` | **keep** `#061b31` (warmer than black, pairs with navy) |
| Body text | `#64748d` | **keep** `#64748d` |
...
| Accent decorative | Ruby `#ea2261` / Magenta `#f96bee` | **do not use** -- N2O is a safety/industrial domain, decorative pink accents are off-brand. Use N2O primary-light `#a5c8ff` for emphasis gradients if needed. |
| Success | `#15be53` / `#108c3d` | **keep** |

**Everything else from sections 1-9 applies as written**: weight-300 display type, negative letter-spacing at display sizes, blue-tinted layered shadows, 4-8px radius scale, 8px spacing unit, dense-data / generous-chrome principle. The navy substitution is the only colour change; the structural DNA is pure Stripe.
