...
class Azienda(Base):
    ...
    cap_legale: Mapped[str | None] = mapped_column(String(5))
    provincia_legale: Mapped[str | None] = mapped_column(String(2))
    ...
    forma_giuridica: Mapped[str | None] = mapped_column(String)
    pec: Mapped[str | None] = mapped_column(String)
    email: Mapped[str | None] = mapped_column(String)
    telefono: Mapped[str | None] = mapped_column(String)
    sito_web: Mapped[str | None] = mapped_column(String)
    numero_dipendenti_dichiarati: Mapped[int | None] = mapped_column(Integer)
    data_costituzione: Mapped[date | None] = mapped_column(Date)
    capitale_sociale: Mapped[float | None] = mapped_column(Numeric)
    rea: Mapped[str | None] = mapped_column(String)
